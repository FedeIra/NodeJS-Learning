...
describe('Routes', function () {
  ...
  describe('/houses', function () {
    it('GET responde con un array vacío de entrada', function () {
      return supertest // supertest nos permxite hacer y testear requests HTTP
...
describe('/spells', function () {
  ...
  describe('/wand', function () {
    ...
    it('GET responde con el string: "el personaje no tiene varxita", si efectivamente no la tiene', function () {
      model.reset();
      model.addHouse('Gryffindor');
      model.addCharacter('Harry', 'Potter', 'Gryffindor', '31-07-1980', false);
      return supertest
        ...
        .expect('Content-Type', /json/)
        .expect(function (res) {
          expect(res.body).to.eql('el personaje no tiene varxita'); // testeamos la respuesta con el body
        });
    });
    ...
    it('POST agrega una nueva varxita (wand) al personaje indicado', function () {
      model.reset();
      model.addHouse('Gryffindor');
      model.addCharacter('Harry', 'Potter', 'Gryffindor', '31-07-1980', false);
      return supertest
        ...
        .expect('Content-Type', /json/)
        .expect(function (res) {
          expect(res.body).to.deep.eql('varxita agregada correctamente');
    ...
    it('POST responde con el string "Ya existe una varxita para este personaje", si el personjae efectivamente ya tiene varxita', function () {
      model.reset();
      model.addHouse('Gryffindor');
      model.addCharacter('Harry', 'Potter', 'Gryffindor', '31-07-1980', false);
      model.addWand('Harry', 'holly', 'phoenix feather', 11);
